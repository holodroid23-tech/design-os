 ...
 * 
 * This component replicates the cash-payment-confirmation mockup using the Compost design system.
 * Shows a confirmation dialog for processing a cash payment.
 */
...
function CashPaymentConfirmationComponent({
  amount = 24.00,
  isOpen: isOpenProp,
  onCancel,
  onConfirm
    ...
    <div className="bg-layer-level-1 border border-layer-level-2 rounded-[18px] max-w-[428px] w-full p-6 space-y-4">
      ...
      <div className="space-y-6 pt-4">
        ...
        <div className="flex items-center justify-center gap-2 text-onLayer-secondary">
          ...
          <span className="text-sm">Method: Cash</span>
        </div>
...
export default function CashPaymentConfirmation(props: CashPaymentConfirmationProps) {
  return <CashPaymentConfirmationComponent {...props} />
}
