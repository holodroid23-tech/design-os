...
export default function ExpenseManagementFolderDetail() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      ...
      <div className="relative flex flex-col h-[85vh] min-h-[600px] aspect-[9/16] max-h-[900px] w-auto bg-background border border-border rounded-3xl shadow-2xl overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        {/* Block 1: Header */}
