...
export default function FirstLaunchOnboardingOrders({
  ...
  items = [
    ...
    { id: "espresso", name: "Espresso", price: "$3.00", tone: "warning" },
    { id: "taro-latte", name: "Taro Latte", price: "$5.50", tone: "accent" },
    {
      id: "americano",
      name: "Americano",
      price: "$3.50",
    ...
    { id: "iced-latte", name: "Iced Latte", price: "$4.75", tone: "info" },
  ],
  onPressItem,
  onPressCustomItem,
