...
export const componentExamplesInventoryGroups: ComponentExampleInventoryGroup[] = [
  ...
  },
  {
    ...
    title: 'Patterns',
    items: [
      { id: 'navigation-menu', title: 'Navigation menu', component: '@/components/patterns/component-examples/sections/patterns-examples#NavigationMenuExamplesCard' },
  ...
  },
  {
    ...
    title: 'Items',
    items: [
      { id: 'item-rows', title: 'Item rows', component: '@/components/patterns/component-examples/sections/item-rows-examples#ItemRowsExamplesCard' },
    ],
  },
  {
    id: 'building-blocks',
