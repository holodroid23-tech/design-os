...
const radioButtonGroupItemVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md font-medium transition-all cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 hover:bg-muted/50 data-[state=checked]:shadow-none",
    {
        variants: {
            variant: {
                ...
                card: "border border-input bg-transparent hover:bg-muted/50 data-[state=checked]:bg-secondary data-[state=checked]:text-secondary-foreground data-[state=checked]:border-transparent whitespace-normal",
            },
            size: {
