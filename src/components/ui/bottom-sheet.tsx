  ...
  return (
    <div
      className={cn(
        ...
        "bg-black text-foreground border border-border rounded-t-[18px] w-full min-h-0 flex flex-col overflow-hidden",
        className,
      )}
      {...props}
    >
      ...
      {footer ? (
        <div className={cn("border-t bg-black p-6", footerClassName)}>{footer}</div>
      ) : null}
    </div>
  )
}
