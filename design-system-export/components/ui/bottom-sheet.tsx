  ...
  return (
    <div
      className={cn(
        ...
        "bg-transparent border border-border rounded-t-[18px] w-full min-h-0 flex flex-col overflow-hidden",
        className,
      )}
      {...props}
    >
      ...
      {footer ? (
        <div className={cn("border-t bg-transparent p-6", footerClassName)}>{footer}</div>
      ) : null}
    </div>
  )
}
