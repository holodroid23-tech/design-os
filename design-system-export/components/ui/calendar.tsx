  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "",
        head_cell:
          "text-muted-foreground rounded-md h-11 font-normal text-[0.8rem] text-center",
        row: "mt-2",
        cell: "h-11 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
        day: cn(
