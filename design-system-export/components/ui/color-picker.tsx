    ...
    <Popover>
      ...
      <PopoverContent className="w-64 p-3" align="start">
        <div className="space-y-3">
          <div>
            <label className="text-xs font-medium text-stone-700 dark:text-stone-300 mb-2 block">
              Custom Color
            </label>
            <input
              type="color"
              ...
              className="w-full h-10 rounded border border-stone-300 dark:border-stone-600 cursor-pointer"
            />
          </div>
          <div>
            <label className="text-xs font-medium text-stone-700 dark:text-stone-300 mb-2 block">
