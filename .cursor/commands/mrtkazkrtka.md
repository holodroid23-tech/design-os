...
## Input Context
When implementing UI, always consider:
- Screen mockup (image or description)
...
```
**Rule**: Check `ComponentExamples.tsx` first. Never create new components. Use existing UI library.
