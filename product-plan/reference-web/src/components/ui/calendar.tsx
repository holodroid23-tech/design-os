  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday:
          "text-muted-foreground flex-1 font-normal text-[0.8rem] text-center h-11 flex items-center justify-center",
        week: "flex w-full mt-2",
        day: "flex-1 h-11 text-center text-sm p-0 relative flex items-center justify-center [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
        day_button: cn(
